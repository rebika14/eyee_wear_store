      ...
      <main className="flex-1 pt-16 md:pt-20">
        ...
        <div className="bg-gray-50 py-8 md:py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-2xl md:text-4xl font-medium mb-3 md:mb-4">Women's Eyewear</h1>
            <p className="text-muted-foreground max-w-xl mx-auto text-sm md:text-base">
              Discover our premium collection of women's optical glasses and sunglasses.
            </p>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4">
            {womenProducts.length > 0 ? (
              ...
              <div className="text-center py-8 md:py-12">
                <p className="text-lg mb-4">No women's products available yet.</p>
